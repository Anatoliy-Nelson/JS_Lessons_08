...
startButton.addEventListener("click", () => {
  ...
  countdownDisplay.textContent = counter; // Отображаем начальное значение счётчика
  ...
  timerId = setInterval(() => {
    ...
    if (counter > 0) {
      ...
      isTimerStarted = false; // Сбрасываем флаг после завершения таймера
    }
  }, 1000);
});
...
cancelButton.addEventListener("click", () => {
  ...
  isTimerStarted = false; // Сбрасываем флаг после отмены таймера
});
